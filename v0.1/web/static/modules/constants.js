...
export const LENS_TILE_EXPLANATIONS = {
  ...
  xmas_market: "Count of Berlin Weihnachtsmärkte within 3 km, from the Berlin Senate's live GeoJSON (berlin.de). Green ≥ 2 within 3 km; amber ≥ 1; red none. Seasonal signal — the feed populates Nov–Dec (~45–50 markets city-wide) and thins to empty the rest of the year. Fetched once at server boot; no live cron.",
