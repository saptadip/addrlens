...
export const LENS_TILE_EXPLANATIONS = {
  ...
  parkzone: "Point-in-polygon check against Berlin's Parkraumbewirtschaftungszonen (Bezirks-maintained paid-parking zones) from gdi.berlin.de. Two-tier signal, resident-friendly framing. Green when the address is inside a zone (residents can buy a Bewohnerparkausweis for ~€10.20/year giving permit priority) OR when it's ≥400 m from any zone edge (real free parking, typical in outer Berlin). Amber when outside but within 400 m of a zone edge — visitor overflow floods your street without giving you permit priority. Doesn't emit a red tier — parking regime in Berlin doesn't naturally split into three under this framing.",
  ...
  xmas_market: "Count of Berlin Weihnachtsmärkte within 3 km, from the Berlin Senate's live GeoJSON (berlin.de). Green ≥ 2 within 3 km; amber exactly 1; red none. The 3 km radius is deliberately generous — Berlin runs only ~45–50 markets city-wide (clustered in Mitte + Charlottenburg), so a tighter walking radius would read red across half the city. Christmas markets are city-scale destinations you travel to, not neighbourhood amenities. Seasonal signal — the feed populates Nov–Dec and thins to empty the rest of the year. Fetched once at server boot; restart to refresh.",
  ...
  cobblestone_nearby: "Distance to the nearest cobblestone road, from OSM ways tagged `surface=sett|cobblestone|unhewn_cobblestone` on trafficked highway classes. INVERTED signal — further is better. Green ≥ 100 m away; amber ≥ 30 m; red inside 30 m. Cobble is heritage-charming by day but noisy at night — passing cars rattle audibly for ~50–80 m even at 30 km/h.",
...
export const GLOSSARY = {
  ...
  'Weihnachtsmarkt': "Christmas market — outdoor stalls selling handcrafts, food, and Glühwein, open in the four weeks of Advent (late Nov to 23 or 24 Dec). Berlin hosts ~45–50 each year across all Bezirke; the Senate lists them in one live feed.",
  'Adventsmarkt': "Advent market — smaller church-yard or courtyard variant of a Weihnachtsmarkt, usually only open on one or two weekends of Advent. Programme typically includes handmade crafts, choir performances, and charity stalls.",
  'Wintermarkt': "Winter market — variant of a Weihnachtsmarkt that runs past 24 Dec, often into January. Same style of stalls (food, Glühwein, handicrafts) without the explicit Christmas framing.",
  'Glühwein': "Mulled wine — red or white wine heated with cinnamon, cloves, orange peel and sugar. The signature drink of any Berlin Weihnachtsmarkt; usually served in a €3–5 souvenir mug with a €2–5 refundable Pfand (deposit).",
  'Advent': "The four-week season before Christmas in the German liturgical calendar (four Sundays before 25 Dec). Weihnachtsmärkte open at the start of Advent and close on 23 or 24 Dec; Adventsmärkte follow the same window.",
  'Veranstalter': "Organiser — the body running a Weihnachtsmarkt (Bezirksamt, a church parish, a business improvement district, or a private events company). The Senate feed carries this per market so newcomers can trace who to contact for questions.",
  'Öffnungszeiten': "Opening hours. Weihnachtsmärkte typically run Mon–Sat 11:00–21:00 and Sun 12:00–20:00, extended on the four Advent weekends; individual markets vary and closing dates fall on 22, 23, 24 or 30 Dec depending on the venue.",
  'Barrierefreiheit': "Step-free access — a German legal term applied here to whether a market is wheelchair- and pram-accessible. The Senate feed carries a per-market flag ('ja' = step-free).",
  'Anwohnerparken': "Berlin's residents-first on-street parking regime. Inside a Parkzone, non-residents pay hourly (€2–4/hr in Berlin, enforcement hours vary by Bezirk); residents can buy a Bewohnerparkausweis for ~€10.20/year giving permit priority. The permit doesn't guarantee a spot, only priority over paying visitors.",
  'Bewohnerparkausweis': "Annual residents' parking permit — ~€10.20/year in Berlin, applied for at the local Bürgeramt with proof of Anmeldung. Valid within one Parkzone only. Needed if you own a car and live inside a paid-parking area.",
  'Parkzone': "One of Berlin's ~103 Parkraumbewirtschaftungszonen — a paid on-street parking polygon set and enforced by each Bezirksamt. Each zone carries its own hourly rate and enforcement hours (typically Mo–Sa 09:00–20:00 in the core; Sundays exempt in most zones).",
  'Parkraumbewirtschaftung': "Umbrella term for Berlin's paid on-street parking policy — devolved to each Bezirksamt for planning, enforcement, and revenue. Zones expand each year as new streets convert; the citywide polygon layer is published live on gdi.berlin.de.",
...
export const TILE_GLOSSARY_KEYS = {
  ...
  parkzone:              ['Anwohnerparken', 'Bewohnerparkausweis',
                          'Parkzone', 'Parkraumbewirtschaftung', 'Bezirk'],
  wochenmarkt:           ['Wochenmarkt'],
  xmas_market:           ['Weihnachtsmarkt', 'Adventsmarkt', 'Wintermarkt',
                          'Glühwein', 'Advent', 'Veranstalter',
                          'Öffnungszeiten', 'Barrierefreiheit', 'Bezirk'],
  nightlife_density:     [],
  ...
  cycling_network:       [],
  car_sharing_reach:     [],
  // parkzone lives on the Commuter lens too — reuse the Newcomer entry
  // above; TILE_GLOSSARY_KEYS is looked up by tile key, not by lens.
  ev_charging_reach:     [],
