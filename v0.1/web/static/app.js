...
// Loading state — skeleton shimmer swapped in after the button click.
function renderLensAISkeleton() {
  return `
...
// panel starts in idle state (button visible); click swaps to skeleton,
