...
def build_messages(context: dict) -> list[dict]:
    ...
    exemplar_assistant = json.dumps({
        ...
        "sections": [
            ...
            {"title": "Cycling & car",
             "tiles": ["cycling_network", "parkzone",
                       "car_sharing_reach", "ev_charging_reach"],
             "verdict": "green",
             "note": "Cycleway on the doorstep; inside Parkzone 12 (Bewohnerparkausweis €10/yr worth it); 4 car-sharing points and 3 EV chargers within 500 m."},
            {"title": "Long-haul travel",
             "tiles": ["airport_reach"],
             "verdict": "amber",
        ...
        "highlights_green": [
            ...
            {"tile": "parkzone",
             "one_line": "Inside Parkzone 12 — Bewohnerparkausweis €10/yr keeps parking predictable."},
