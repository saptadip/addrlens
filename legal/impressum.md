...
_Angaben gemäß § 5 DDG (Digitale-Dienste-Gesetz)_
...
generierte Textzusammenfassungen (Large Language Model), die trotz
Sorgfalt fehlerhaft oder ungenau sein können. Für Wohnungs-,
Investitions- oder Standortentscheidungen sollten die dargestellten
Informationen stets durch weitere Quellen und persönliche Besichtigung
überprüft werden.
...
- **OpenStreetMap** — Open Database License (ODbL) 1.0, © OpenStreetMap
  contributors, aufbereitet als wöchentlicher Geofabrik-Berlin-Extrakt.
- **VBB Verkehrsverbund Berlin-Brandenburg GmbH** — CC-BY 4.0.
- **BVG Berliner Verkehrsbetriebe** — dl-de/by-2-0.
- **GESIx (Gesundheits- und Sozialstrukturatlas 2022)** —
  Senatsverwaltung für Wissenschaft, Gesundheit, Pflege und
  Gleichstellung, dl-de/zero-2-0.

Detaillierte Quellenangaben werden je Datenkarte im Produkt angezeigt.
...
pages under § 7 (1) DDG in accordance with general laws. Under §§ 8-10
DDG, however, as a service provider we are not obliged to monitor
...
generated text summaries produced by a large-language model, which
despite care may contain errors or inaccuracies. For housing,
investment, or location decisions, the information presented should
always be verified through additional sources and personal inspection.

Obligations to remove or block the use of information under general
laws remain unaffected. Liability in this respect is however only
possible from the point in time at which a concrete legal violation
becomes known. Upon notification of any such violations, we will
...
- **OpenStreetMap** — Open Database License (ODbL) 1.0, © OpenStreetMap
  contributors, processed as a weekly Geofabrik Berlin extract.
- **VBB Verkehrsverbund Berlin-Brandenburg GmbH** — CC-BY 4.0.
- **BVG Berliner Verkehrsbetriebe** — dl-de/by-2-0.
- **GESIx (Health and Social Structure Atlas 2022)** — Berlin Senate
  Department for Science, Health, Care and Equality, dl-de/zero-2-0.

Detailed source attribution is displayed per card within the product.
